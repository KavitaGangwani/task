      ...
      <div className=' bg-white text-center p-6'>
        ...
        <div className='w-[95%] mx-auto '>
          <div className='flex justify-around'>
            ...
            <TestCard image = {img2} name="Anjan Banerjee" desc="The website and app are incredibly intuitive and easy to navigate. Whether you’re a seasoned trader or a beginner, you’ll find everything you need right at your fingertips.
          ...
          <div className='flex justify-around'>
            <TestCard image = {img1} name="Vibha Hegde" desc="The website and app are incredibly intuitive and easy to navigate. Whether you’re a seasoned trader or a beginner, you’ll find everything you need right at your fingertips.
                    Overall, NiftyTrader has exceeded my expectations in every way." />
